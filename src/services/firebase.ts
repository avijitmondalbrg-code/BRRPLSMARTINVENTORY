...
// FIX: Force Long Polling to resolve "Could not reach backend" WebSocket errors.
// Removed 'merge: true' as it is not a valid property for Firestore settings.
...
export const fetchCollection = async (collectionName: string) => {
  try {
    ...
    throw error; // Throw so App.tsx can handle the fallback
  }
};
