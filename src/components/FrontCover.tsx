    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      <div className="max-w-6xl w-full z-10 flex flex-col items-center">
        <div className="text-center mb-16">
          <div className="bg-white p-6 rounded-3xl inline-block mb-8 shadow-2xl border border-white/10">
          ...
          <p className="text-xl text-teal-300 font-bold uppercase tracking-[0.2em]">{COMPANY_TAGLINE}</p>
        </div>
        ...
        <div className="mt-16">
            <button onClick={() => onNavigate('dashboard')} className="flex items-center gap-3 bg-teal-600 hover:bg-teal-500 text-white text-lg font-black py-4 px-12 rounded-full shadow-2xl shadow-teal-900/50 transition-all hover:scale-105 active:scale-95 uppercase tracking-widest">
