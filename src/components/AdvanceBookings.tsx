              ...
              <div className="flex justify-between border-b-2 border-gray-800 pb-6 mb-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1 italic">{COMPANY_TAGLINE}</p>
                    <p className="text-[10px] text-gray-500 mt-2 leading-tight">{COMPANY_ADDRESS}</p>
                    <p className="text-[9px] text-gray-500 font-bold mt-1">Ph: {COMPANY_PHONES} | Email: {COMPANY_EMAIL}</p>
                    <p className="text-[8px] text-gray-400 uppercase mt-2 font-bold">GSTIN: {CLINIC_GSTIN}</p>
                  </div>
                </div>
