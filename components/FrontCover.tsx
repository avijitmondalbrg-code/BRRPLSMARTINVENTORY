...
import { ArrowRight, Package, FileText, Users, Briefcase, LayoutDashboard } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl w-full z-10 flex flex-col items-center">
        ...
        {/* Quick Access Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 w-full max-w-5xl animate-fade-in-up delay-150">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Sales CRM</h3>
          ...
          >
            ...
            <p className="text-xs text-slate-400">Stock & Transfers</p>
          </button>
          ...
          >
            ...
            <p className="text-xs text-slate-400">Directory & History</p>
          </button>
        ...
        <div className="absolute bottom-6 text-slate-500 text-xs text-center w-full">
            ...
            <p className="mt-1 opacity-50">Version 2.4.0 • Authorized Access Only</p>
        </div>
